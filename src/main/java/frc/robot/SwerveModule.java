...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        /* Angle Motor Config */
        mAngleMotor = new HighlanderFalcon(moduleConstants.angleMotorID);
        configAngleMotor();

        /* Drive Motor Config */
        mDriveMotor = new HighlanderFalcon(moduleConstants.driveMotorID);
        configDriveMotor();
    }
    ...
    private void setAngle(SwerveModuleState desiredState){
        ...
        Rotation2d angle = (Math.abs(desiredState.speedMetersPerSecond) <= (Constants.Swerve.maxSpeed * 0.01)) ? getAngle() : desiredState.angle; 
