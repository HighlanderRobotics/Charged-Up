...
public class SwerveModule {
    ...
    public SwerveModulePosition getPosition(){
        SmartDashboard.putNumber(moduleNumber + " pose", Conversions.falconToMeters(mDriveMotor.getSelectedSensorPosition(), Constants.Swerve.wheelCircumference, Constants.Swerve.driveGearRatio));
