...
public interface VisionIO {
    public static class VisionIOInputs implements LoggableInputs {
        ...
        public void getLoggedPhotonTrackedTarget(PhotonTrackedTarget target, LogTable table, String name) {
            ...
            double[] minAreaRectCornersX = table.getDoubleArray("min area rect corners x " + name, new double[4]);
            double[] minAreaRectCornersY = table.getDoubleArray("min area rect corners y " + name, new double[4]);
